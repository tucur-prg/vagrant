...
$ wget http://central.maven.org/maven2/com/google/code/simple-spring-memcached/spymemcached/2.8.4/spymemcached-2.8.4.jar
...
**コンパイル**
```
$ javac -cp couchbase-client-1.4.10.jar:spymemcached-2.8.4.jar Send.java
```

**実行**
```
$ java -cp .:couchbase-client-1.4.10.jar:spymemcached-2.8.4.jar:jettison-1.1.jar:netty-3.2.0.Final.jar:commons-codec-1.5.jar:httpcore-4.3.jar:httpcore-nio-4.3.2.jar Send
```
